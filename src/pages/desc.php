<div class="w-screen h-full flex justify-between items-center">
    ...
    <div class="w-[45%] py-16 mr-20 flex flex-col justify-center items-center gap-20 bg-[#ffffdc] rounded-3xl">
        ...
        <form method="POST">
            ...
            <button type="submit" class="bg-[#C37A67] px-10 py-5 rounded-full font-inter font-bold text-xl text-white hover:bg-[#9CAF88] relative -right-72"><?php if (isset($_SESSION['role']) && $_SESSION['role'] == 'admin') { echo 'DELETE'; } else { echo 'Borrow NOW'; } ?></button>
        </form>
    </div>
