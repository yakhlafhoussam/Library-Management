<div class="w-full min-h-full flex flex-col justify-center items-center gap-12 relative">
    ...
    <div class="w-1/2 bg-[#ffffdc] px-10 py-12 rounded-2xl flex flex-col justify-center items-center gap-8">
        <img class="w-20" src="<?php if ($userInfo['gender'] == 'M') { echo 'assets/img/man.png'; } else { echo 'assets/img/woman.png'; } ?>" alt="">
        <h1 class="w-full font-inter font-semibold text-black flex justify-between items-center"><span class="text-lg text-gray-600">First name :</span><span class="text-black"><?php echo $userInfo['first'] ?></span></h1>
        <h1 class="w-full font-inter font-semibold text-black flex justify-between items-center"><span class="text-lg text-gray-600">Last name :</span><span class="text-black"><?php echo $userInfo['last'] ?></span></h1>
        <h1 class="w-full font-inter font-semibold text-black flex justify-between items-center"><span class="text-lg text-gray-600">Email :</span><span class="text-black"><?php echo $userInfo['email'] ?></span></h1>
        <h1 class="w-full font-inter font-semibold text-black flex justify-between items-center"><span class="text-lg text-gray-600">Number of borrow :</span><span class="text-black"><?php /* echo $username */ ?></span></h1>
