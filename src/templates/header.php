<header class="w-full h-[10%] flex items-center justify-between px-10 z-[9999] fixed bg-[#fcfbf8]">
    ...
    <div class="w-1/2 h-full flex justify-around items-center">
        <a id="home" class="font-inter font-bold text-xl <?php if ($page == "/") { echo "border-b-2 text-[#36454F]"; } else { echo "hover:scale-105 text-[#9CAF88]"; } ?>" href="/">Home</a>
        ...
        <a id="book" class="font-inter font-bold text-xl <?php if ($page == "/book") { echo "border-b-2 text-[#36454F]"; } else { echo "hover:scale-105 text-[#9CAF88]"; } ?>" href="book">Books</a>
