<header class="w-full h-[10%] flex items-center justify-between px-10 z-[9999] fixed bg-[#fcfbf8]">
    <a class="w-1/4 flex gap-1" href="KEO">
    ...
    <div class="w-1/2 h-full flex justify-around items-center">
        ...
        <a id="book" class="font-inter font-bold text-xl transition-transform <?php if ($page == "/book") { echo "border-b-2 text-[#36454F]"; } else { echo "hover:scale-105 text-[#9CAF88]"; } ?>" href="book">Books</a>
    </div>
    <div class="h-full w-1/4 flex justify-end items-center gap-2">
        <a href="login" class="bg-[#C37A67] py-3 w-32 text-center rounded-full font-inter font-bold text-xl transition-transform hover:scale-[1.02] text-white hover:bg-[#9CAF88]">Log in</a>
